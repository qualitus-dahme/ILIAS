...
class ilBadgesFilesMigration implements Migration
{
    ...
    public function step(Environment $environment): void
    {
        ...
        if ($image !== '' && $image !== null) {
            ...
            try {
                $io->inform("Trying to move badge file {$image_path} for id {$id} to the storage service.");
                ...
                $io->error("Failed to move badge file {$image_path} for id {$id} to the storage service with exception: {$e->getMessage()}");
